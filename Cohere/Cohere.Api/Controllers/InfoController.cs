...
namespace Cohere.Api.Controllers.V1
{
    ...
    public class InfoController : ControllerBase
    {
        ...
        public IActionResult ApiInfo()
        {
            ...
            var connstring = Configuration["ConnectionStrings:CohereDB"];
            ...
            return Content(
                ...
                "<div class='jumbotron'>" +
                "<h1><i class='fab fa-centercode' fa-2x></i>  Cohere Api v.1</h1>" +
                "<h4>v.4.3</h4>" +
                 ...
                 "<li>Use InMemory Database: " + memorydb + "</li>" +
                  ...
                  (authentication == "True" ? "<li>IndentityServer4IP: " + is4ip + "</li>" : string.Empty) +
...
namespace Cohere.Api.Controllers.V2
{
    [ApiVersion("2.0")]
    [Route("api/v{version:apiVersion}/[controller]")]
    [ApiController]
    public class InfoController : ControllerBase
    {
        ...
        public IActionResult ApiInfo()
        {
            ...
            return Content(
                ...
                "<div class='jumbotron'>" +
                "<h1><i class='fab fa-centercode' fa-2x></i>  Cohere Api v.2</h1>" +
                "<h4>v.4.2</h4>" +
                 "NET.Core Api REST service started!<br>" +
                 "appsettings.json configuration:<br>" +
                 "<ul><li>NetCore: 3.0</li>" +
